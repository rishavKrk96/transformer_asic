...
analyze -format verilog -lib WORK sync_2d.v
analyze -format verilog -lib WORK icg.v
analyze -format verilog -lib WORK controller.v
analyze -format verilog -lib WORK norm.v
analyze -format verilog -lib WORK fifo_top.v
analyze -format verilog -lib WORK fifo_depth64.v
