...
createPlaceBlockage -box [list 10 300 120 460]
createPlaceBlockage -box [list 180 20 550 120]
...
addStripe -number_of_sets 20  -spacing 6 -layer M4 -width 2 -nets { VSS VDD }
#################################################
